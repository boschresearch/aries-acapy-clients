...
public class V20CredIssue {
    ...
    public static final String SERIALIZED_NAME_CREDENTIALS_TILDE_ATTACH = "credentials~attach";
    @SerializedName(SERIALIZED_NAME_CREDENTIALS_TILDE_ATTACH)
    private List<AttachDecorator> credentialsTildeAttach = new ArrayList<>();
