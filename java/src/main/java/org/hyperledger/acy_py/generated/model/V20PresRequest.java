...
public class V20PresRequest {
    ...
    @SerializedName(SERIALIZED_NAME_REQUEST_PRESENTATIONS_TILDE_ATTACH)
    private List<AttachDecorator> requestPresentationsTildeAttach = new ArrayList<>();
    public static final String SERIALIZED_NAME_WILL_CONFIRM = "will_confirm";
    @SerializedName(SERIALIZED_NAME_WILL_CONFIRM)
